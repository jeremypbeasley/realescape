...
The REST hotline is available twenty-four hours a day, seven days a week. Through it, we connect with individuals who have been exploited, or are currently being exploited in the sex trade. Callers and texters often reach out in crisis and receive emotional support, information, and referrals for resources. In most cases, our advocates are able to respond in person to help meet a victim’s immediate needs. <img src="/uploads/REST_Annual-Report-2017_Hotline.png" alt="REST Hotline" style="float:right;width:300px;height:300px;margin:0px 0px 10px 10px;"> 
